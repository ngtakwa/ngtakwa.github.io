<img src="assets/img/avatar2.png" width="160" align="right" style="margin-left: 20px; margin-bottom: 10px; border-radius: 50%;">
...
## Research Interests
I am interested in applying **Stochastic Control** and **Game Theory** in **Actuarial Science** and **Financial Mathematics**.
...
1. Boonen, T. J., **Ng, T. W.**, & Nguyen, T. (2026). Contractibility, Peer-to-Peer Insurance, and Moral Hazard. *SSRN preprint*. (<a href="https://ssrn.com/abstract=6320070">SSRN</a>)
...
## Miscellaneous
* I spent two years backpacking in Australia, where I completed my first skydive and bungee jump.
* I cycled around Tasmania and Taiwan (New Zealand and Iceland are next on my bucket list).
* I reached the summit of Mount Kinabalu (a typhoon unfortunately stopped my attempt on Mount Fuji).
